...
## Project Structure
    ...
    ├── vcxs_admin_dashboar_32909  # Django project configurations
...
1. Clone this repo and `cd vcxs_admin_dashboar_32909`
...
2. Clone this repo and `cd vcxs_admin_dashboar_32909`
